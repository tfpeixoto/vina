...
function vina_scripts()
{
  ...
  wp_enqueue_script('bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js', array('jquery'), '4.5.3', true);
  ...
  wp_enqueue_script('acoes', get_template_directory_uri() . '/assets/js/critical.js', array(), '1.0', true);
}
